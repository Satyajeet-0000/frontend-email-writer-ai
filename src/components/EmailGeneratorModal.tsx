...
// -------------------------------------------------------------------------
// STEP 1: Define the base URL using the environment variable
// This variable will be set to 'https://email-writer-ai-1.onrender.com' in production
...
const handleGenerate = async () => {
  ...
  try {
    // -------------------------------------------------------------------------
    // STEP 2: Update the URL to use the BASE_URL constant
